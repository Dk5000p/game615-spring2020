...
public class PieceBehaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (enemy&&Vector3.Distance(agent.transform.position,enemy.transform.position)<2) // if the GameState set an enemy for us (the destination piece is occupied by enemy, then 
        {
